...
module amm::fees_tests {
    ...
    fun sets_initial_state_correctly() {
        ...
        next_tx(test, alice);
        {
            ...
            assert_eq(fees.shiller(), ONE_PER_CENT * 10);
        };
        test::end(scenario);      
    }
    ...
    fun calculates_fees_properly() {
        ...
        next_tx(test, alice);
        {
            ...
            assert_eq(fees::get_shiller_amount(&fees, amount), 11);
    ...
    fun aborts_max_liquidity_fee() {
        ...
        next_tx(test, alice);
        {
            ...
            fees.update_liquidity(option::some(MAX_LIQUIDITY_FEE + 1));
        };
        test::end(scenario);
    } 
    ...
    fun aborts_max_shiller_fee() {
        ...
        next_tx(test, alice);
        {
            ...
            fees.update_shiller(option::some(MAX_SHILLER_FEE + 1));
        };
        test::end(scenario);
    } 
}