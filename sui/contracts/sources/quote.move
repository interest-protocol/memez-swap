module amm::memez_amm_quote {
    ...
    public fun amount_out<CoinIn, CoinOut>(pool: &MemezPool, amount_in: u64): u64 { 
        if (is_coin_x<CoinIn, CoinOut>()) {
            ...
            memez_amm_invariant::get_amount_out(
    ...
    public fun amount_in<CoinIn, CoinOut>(pool: &MemezPool, amount_out: u64): u64 {
        ...
        if (is_coin_x<CoinIn, CoinOut>()) {
            ...
            sub_fees_in<CoinIn>(
                fees, 
                memez_amm_invariant::get_amount_in(amount_out, balance_x, balance_y), 
                burn_coin,
                multiplier_x
            )
        } else {
            ...
            sub_fees_in<CoinIn>(
                fees, 
                memez_amm_invariant::get_amount_in(amount_out, balance_y, balance_x), 
                burn_coin,
                multiplier_y
            )
        }
