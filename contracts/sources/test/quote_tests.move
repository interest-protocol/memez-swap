...
module amm::quote_tests {
    ...
    use amm::{
        ...
        usdc::USDC,
        fees::{Self, Fees},
        curves::{Volatile, Stable},
        ipx_v_eth_usdc::IPX_V_ETH_USDC,
        ipx_s_usdc_usdt::IPX_S_USDC_USDT,
        interest_protocol_amm::{Self, Registry, InterestPool},
        deploy_utils::{people, scenario, deploy_eth_usdc_pool, deploy_usdc_usdt_pool}
    };
    ...
    fun test_volatile_quote_amount_out() {
        ...
        next_tx(scenario_mut, alice);
        {
            ...
            assert_eq(quote::amount_out<ETH, USDC, IPX_V_ETH_USDC>(&request.pool, amount_in), expected_amount_out);
        ...
        next_tx(scenario_mut, alice);
        {
            ...
            assert_eq(quote::amount_out<USDC, ETH, IPX_V_ETH_USDC>(&request.pool, amount_in), expected_amount_out);
    ...
    fun test_stable_quote_amount_out() {
        ...
        next_tx(scenario_mut, alice);
        {
            ...
            assert_eq(quote::amount_out<USDC, USDT, IPX_S_USDC_USDT>(&request.pool, amount_in), expected_amount_out);
        ...
        next_tx(scenario_mut, alice);
        {
            ...
            let expected_amount_out = expected_amount_out - fees::get_fee_out_amount(&request.pool_fees, expected_amount_out); 
            assert_eq(quote::amount_out<USDT, USDC, IPX_S_USDC_USDT>(&request.pool, amount_in), expected_amount_out);
    ...
    fun test_volatile_quote_amount_in() {
        ...
        {   
            ...
            assert_eq(quote::amount_in<ETH, USDC, IPX_V_ETH_USDC>(&request.pool, amount_out), expected_amount_in);
        ...
        next_tx(scenario_mut, alice);
        {
            ...
            assert_eq(quote::amount_in<USDC, ETH, IPX_V_ETH_USDC>(&request.pool, amount_out), expected_amount_in);
    ...
    fun test_stable_quote_amount_in() {
        ...
        next_tx(scenario_mut, alice);
        {
            ...
            assert_eq(quote::amount_in<USDC, USDT, IPX_S_USDC_USDT>(&request.pool, amount_out), expected_amount_in);
        ...
        {      
            ...
            assert_eq(quote::amount_in<USDT, USDC, IPX_S_USDC_USDT>(&request.pool, amount_out), expected_amount_in);
  ...
  fun test_quote_add_liquidity() {
    ...
    fun test_remove_liquidity() {
        ...
        next_tx(scenario_mut, alice);
        {
            ...
            let (eth_amount, usdc_amount) = quote::remove_liquidity<ETH, USDC, IPX_V_ETH_USDC>(&request.pool, amount);
